...
//nouvelle partie
strcpy(win->img1.nom_img1,"btn1.png");
strcpy(win->img1.nom_img2,"btn2.png");
...
//charger
strcpy(win->img1.nom_img1,"btn1.png");
strcpy(win->img2.nom_img2,"btn2.png");
...
//charger
strcpy(win->img2.nom_img1,"btn1.png");
strcpy(win->img1.nom_img2,"btn2.png");
